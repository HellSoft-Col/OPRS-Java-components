...
public class ProxyBP {
    ...
    public ProxyBP() {
        ...
        webTarget = client.target(BASE_URI).path("serachProperty");
    }
    ...
    public <T> T searchProperties_XML(Object requestEntity, Class<T> responseType) throws ClientErrorException {
    ...
    public <T> T searchProperties_JSON(Object requestEntity, Class<T> responseType) throws ClientErrorException {
